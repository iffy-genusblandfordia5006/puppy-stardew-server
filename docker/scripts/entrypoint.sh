#!/bin/bash
# Puppy Stardew Server Entrypoint Script - v1.0.35 SIMPLIFIED
# 小狗星谷服务器启动脚本 - v1.0.35 简化版
...
log_step "================================================"
log_step "  Puppy Stardew Server v1.0.35 Starting..."
log_step "  小狗星谷服务器 v1.0.35 启动中..."
log_step "================================================"
